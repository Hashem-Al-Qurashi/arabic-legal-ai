...
async def _generate_streaming_response(
    ...
    try:
        ...
        # Get enhanced RAG engine with Islamic integration
        rag_instance = get_rag_engine()
        
        print(f"🔄 Processing with ENHANCED RAG engine - context: {len(context)} messages")
        print(f"🕌 Quranic integration: ENABLED for all Arabic queries")
