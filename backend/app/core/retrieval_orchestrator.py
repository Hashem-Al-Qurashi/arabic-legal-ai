    ...
    async def retrieve_integrated(self, query: str, 
        ...
        try:
            ...
            response = IntegratedResponse(
                ...
                civil_search_time=search_times.get("civil", search_times.get("civil_search_time", 0.0)),
                quranic_search_time=search_times.get("quranic", search_times.get("quranic_search_time", 0.0)),
